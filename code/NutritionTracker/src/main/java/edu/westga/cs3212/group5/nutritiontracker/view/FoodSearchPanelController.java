...
public class FoodSearchPanelController {
    ...
    void initialize() {
        ...
        this.resultsListView.getSelectionModel().selectedItemProperty()
                .addListener((obs, oldVal, newVal) -> {
                    ...
                    if (this.portionSizeRow != null && this.portionSizeRow.isVisible()
                            && newVal != null) {
    ...
    /**
     * Switches the panel into ingredient mode by showing the portion size spinner row.
     */
    ...
    private void fireAddSelectedFood() {
        if (this.onAddSelectedFood != null) {
            ...
            new Alert(Alert.AlertType.INFORMATION,
                    "\"" + this.currentlySelectedFood.getDescription() + "\" added!")
                    .showAndWait();
            this.reset();
        }
    }
    ...
    private void refreshResults() {
        ...
        try {
            String request = SearchRequestHandler.createSearchRequest(
                    query == null || query.isBlank() ? "a" : query);
            ...
            this.statusLabel.setText(results.isEmpty()
