 ...
 * @version spring 2026
 */
public class DietGoalsController {
	...
	@FXML
	void initialize() {
		assert this.backButtonLabel != null
				: "fx:id=\"backButtonLabel\" was not injected: check your FXML file 'PreferencesPage.fxml'.";
		...
		assert this.createAccountButton != null
				: "fx:id=\"createAccountButton\" was not injected: check your FXML file 'PreferencesPage.fxml'.";
